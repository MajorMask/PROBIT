 ...
 * Generated: 2025-11-09T09:56:21.819910
 * 
 * Central region: degree (6, 6)
 *   Max error: 1.391076e-05
 *   Mean error: 1.212220e-06
 * 
 * Tail region: degree (8, 8)
 *   Max error: 2.742556e-06
 *   Mean error: 9.102334e-07
 * 
...
class InverseCumulativeNormal {
  ...
  private:
    ...
    static constexpr double CENTRAL_A[7] = {
        2.506632848800842250e+00,
        -1.422425092229492094e+01,
        1.444893119014403915e+01,
        1.124743207992664296e+01,
        6.233390081346965594e+00,
        5.357397078550604874e+00,
        1.547639643978701240e+00
    };

    static constexpr int CENTRAL_N = 6;
    static constexpr double CENTRAL_B[7] = {
        1.000000000000000000e+00,
        -6.721659783948956246e+00,
        1.049524248909546742e+01,
        2.763668408857859582e+00,
        -1.235388683453659819e+00,
        -4.073675421673749852e+00,
        9.576785507368641426e-01
    };

    // Tail region: degree (8, 8)
    static constexpr int TAIL_P = 8;
    static constexpr double TAIL_C[9] = {
        -1.687872225789323943e+00,
        3.687746846448785920e+00,
        -2.179795919414893035e+00,
        2.762707414104418890e-01,
        -4.107645052565004479e-02,
        3.530663936248290991e-03,
        -1.876362805751968148e-04,
        3.335593420361751489e-05,
        -6.029944645004713444e-06
    };

    static constexpr int TAIL_Q = 8;
    static constexpr double TAIL_D[9] = {
        1.000000000000000000e+00,
        -1.103321187453011332e+00,
        -4.298807817736784859e-02,
        2.606369263715265297e-02,
        -6.333889516508184846e-03,
        8.073182985944637275e-04,
        -3.359171044769373445e-05,
        -3.476797288407960515e-06,
        -4.309702358696795437e-08
    };
